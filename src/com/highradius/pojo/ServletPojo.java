...
public class ServletPojo {
	...
	public int getDue_in_date() {
		return due_in_date;
	}
	public void setDue_in_date(int due_in_date) {
	...
	public int getBaseline_create_date() {
		return baseline_create_date;
	}
	public void setBaseline_create_date(int baseline_create_date) {
